...
/**
 * File Description:  This class provides a list of useful methods for reading/writing to {@link SharedPreferences}
...
public class SharedPrefUtil {
    private static final String PREF_FILE = "MoviesPrefFile";
